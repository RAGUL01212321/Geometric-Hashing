...
protiein_fileName=file_path[47:len(file_path)-4] # Gets the protein file id from the actual file path
...
df_final.to_csv(f"{protiein_fileName}_preprocessed.csv", index=False)
