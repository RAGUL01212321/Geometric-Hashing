...
def find_similar_proteins(query_features, hash_table):
...
similar_proteins = find_similar_proteins(query_protein_features, hash_table)

print("✅ Similar proteins found:", similar_proteins)
